...
COUNTRY_DATA.france = {
  ...
  treatments: {
    ...
    spine_surgery_cervical_lumbar: { usd: [11000, 22000], local: [10000, 20000] },
    ...
    gallbladder_surgery: { usd: [880, 2200], local: [800, 2000] },
    ...
    maternity_delivery_package: { usd: [3300, 8800], local: [3000, 8000] },
